...
if ($operacion == 'CONTACTO') {
    ...
    // $sqlRepetido = "Select ContactoID from usuariocontacto where Correo='$correo' and UsuarioID = '$idusuario'";
    // $datosRepetidos = $conexion->query($sqlRepetido);
    //if (($datosRepetidos->num_rows == 0) && ($nombre != '') && ($correo !='')){
    if (($nombre != '') && ($correo !='')){
...
if ($operacion == 'GRUPOBORRAR') {
    ...
    $sqlBorrarUsuario = "Delete from usuariocontacto Where GrupoID = '$grupo' and UsuarioID = '$idusuario'";
